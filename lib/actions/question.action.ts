...
export async function getQuestions(params: GetQuestionsParams) {
  try {
    ...
    // Calculate the number off posts to skip based on the page number and page size
...
export async function upvoteQuestion(params: QuestionVoteParams) {
  try {
    ...
    // Increment author's reputation by +10/-10 for reciving an upvote/downvote to the question
